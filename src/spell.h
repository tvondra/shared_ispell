...
void SharedNIStartBuild(IspellDict *Conf);
void SharedNIImportAffixes(IspellDict *Conf, const char *filename);
void SharedNIImportDictionary(IspellDict *Conf, const char *filename);
void SharedNISortDictionary(IspellDict *Conf);
void SharedNISortAffixes(IspellDict *Conf);
void SharedNIFinishBuild(IspellDict *Conf);
